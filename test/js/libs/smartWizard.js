function SmartWizard(target, options) {
    ...
    this.contentWidth = 0;
    this.buttons = {
        next: $('<a>' + options.labelNext + '</a>').attr("href", "#").addClass("btn tp-btn tp-btn-grey actionBar buttonNext"),
        previous: $('<a>' + options.labelPrevious + '</a>').attr("href", "#").addClass("btn tp-btn tp-btn-grey actionBar buttonPrevious pull-left"),
        finish: $('<a>' + options.labelFinish + '</a>').attr("href", "#").addClass("btn tp-btn actionBar buttonFinish")
    };
    ...
    var _showStep = function ($this, stepIdx) {
        ...
        /** CUSTOM AJAY-30-01-2015 */
        if ((selStep).attr('rel') == 1) {
            $this.elmStepContainer.height(409);
        } else {
